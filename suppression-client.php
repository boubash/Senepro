<?php
  ...
  $commandes = "SELECT id_commande FROM commande WHERE id_client=".$id;
    //selection de toute les commande appartenant au client a supprimer
  //création d'une chaine de caractére contenant tous les identifiants des commandes consernées
  ...
  //selection de toutes les lignes de commandes incluses dans les commandes
  $id_ligne_commandes = "";
  if ("" != $id_commandes) {
